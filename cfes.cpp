...
//Initialization.......................................
	...
	std::string input_probability_file_address;
	...
	input_file >> read_string >> input_probability_file_address;
	input_file >> read_string >> tau;
	input_file >> read_string >> k_b;
	input_file >> read_string >> T;
	input_file >> read_string >> m;

	std::ifstream input_probability_file(input_probability_file_address.c_str());
	...
	input_probability_file >> read_string >> bins;
	for(int i = 0; i < bins; i++){
		double e, p;
		input_probability_file >> e >> p;
		E_bins[i] = e;
		E_Prob_ref[i] = p;
	}
