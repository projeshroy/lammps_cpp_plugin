...
//Initialization.......................................
	double k_b, T, E_min, E_max, binwidth, 
	       E_mean_incr_percentage, E_sigma_incr_percentage, E_norm_incr_percentage, 
	       sigma_shift_parameter, max_dE;
	int output_steps, equil_steps, total_steps, tau, m, TOTAL_ATOMS, tau_equil;
	std::string atom_index_file_address, mode;
	...
	Vec_d E_Prob; E_Prob.resize(bins); E_Prob.setZero();
...
//Gaussian Approximation...............................
	...
	double E_sigma = 0;
	double E_norm = 0;
	E_Prob = E_tot_hist_equil/E_tot_hist_equil.sum(); 
...
//CFES code............................................	
	...
	for (int i = 0; i < total_steps; i++){
		...
		if(sqrt(dE_factor*dE_factor) >= (max_dE*k_b*T))
		dE_factor = max_dE*k_b*T;
		}
		else {
		dE_factor = max_dE*k_b*T;
		...
		for(int i = 0; i < TOTAL_ATOMS; i++){
			...
			for(int d = 0; d < 3; d++){
				...
				if((i > 0) && (dx > 0) && (i % tau == 0))
				force[id][d] += (-dE_factor/(3*TOTAL_ATOMS*dx_mod))*(dx/dr_mod);
